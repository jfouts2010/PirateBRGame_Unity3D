...
namespace emotitron.NST
{
	...
	{
		//public Network.Compression.FloatRange testfloat = new Network.Compression.FloatRange(-10f, 10f, 01f, Network.Compression.Axis.Generic, Network.Compression.RangeType.Generic);
