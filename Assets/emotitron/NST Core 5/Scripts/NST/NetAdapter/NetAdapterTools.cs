...
namespace emotitron.NST
{
	...
	public static class NetAdapterTools
	{
		...
		public static bool ChangeLibraries(NetworkLibrary newLib)
		{
			...
			dependenciesNeedToBeCheckedEverywhere = true;
		...
		{
			if (!dependenciesNeedToBeCheckedEverywhere)
				return;

			Debug.LogWarning("TRYING TO ADD");
			...
			dependenciesNeedToBeCheckedEverywhere = false;
		}
